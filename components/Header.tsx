...
{!!session?.user ? <SheetContent side="left" className="w-64 p-0">
        ...
        {/* Logo */}
        <Link href="/" className="text-lg font-semibold tracking-[0.2em] uppercase text-background/50">
          No Signal
        </Link>
        ...
        {session?.user && <nav className="hidden items-center gap-8 sm:flex">
          <NavLink
            href="/products"
            className="text-sm text-muted-foreground transition-colors hover:text-background/50"
        ...
        {!!session?.user ?  <Link
          href="/cart"
          className="text-muted-foreground transition-colors hover:text-background/50"
        >
          <ShoppingCart className="h-5 w-5" />
                ...
                className="border-border text-white/50 px-6 py-4 text-sm font-medium flex items-center gap-2 transition-colors hover:text-white/70"
                >
                <ScanFace />
                Sign In
                </Link>}
